...
const Footer = () => {
  return (
    <footer className="flex flex-col lg:flex-row justify-between bg-black px-8 lg:px-32 py-10 mt-10 mb-10 shadow-lg">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4">
            ...
            <Link href="https://www.linkedin.com" passHref>
              <FaLinkedin
                size={35}
                className="cursor-pointer text-white hover:text-blue-800"
              />
            </Link>
